...
import docstore.model.CompareDocuments200Response
import docstore.model.CompareDocuments400Response
import docstore.model.CompareDocumentsRequest
import docstore.model.CopyDocument200Response
import docstore.model.CopyDocument404Response
import docstore.model.CopyDocumentRequest
import docstore.model.DeleteDocument200Response
import docstore.model.GetDocument404Response
import docstore.model.GetMetadata200Response
import docstore.model.SaveDocument200Response
import docstore.model.UpdateDocument200Response
...
class DefaultRoutes(service: DefaultService) extends cask.Routes {
  ...
  def saveDocument(path: String, request: cask.Request) = {
    ...
    val result = for {
      path <- Parsed(path)
      body <- Parsed
        .eval(read[Map[String, ujson.Value]](request.bodyAsString))
        .mapError(e =>
          s"Error parsing json as a string map of Object from >${request.bodyAsString}< : ${e}"
