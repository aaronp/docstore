...
// mill _.publishLocal
// mill _.test.test
object docstore extends SbtModule with ScalafmtModule with PublishModule {
  def scalaVersion = "3.4.1"

  def pomSettings = PomSettings(
    description = "docstore",
    organization = "kindservices",
    url = "https://github.com/<username>/docstore",
    licenses = Seq(License.MIT),
    versionControl = VersionControl.github("<username>", "docstore"),
    developers = Seq(
